  ...
  {  
   ...
   MovieDemo()
     {  
      try
        {
         autoResources = ResourceBundle.getBundle("resources.MovieResources",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(autoResources.getString("MovieDemo"));  
